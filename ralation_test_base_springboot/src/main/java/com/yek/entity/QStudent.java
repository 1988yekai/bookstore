...
public class QStudent extends EntityPathBase<Student> {
    ...
    private static final long serialVersionUID = -1001178228L;
    ...
    public final SetPath<Teacher, QTeacher> teacherList = this.<Teacher, QTeacher>createSet("teacherList", Teacher.class, QTeacher.class, PathInits.DIRECT2);
    ...
    public QStudent(Class<? extends Student> type, PathMetadata metadata, PathInits inits) {
        ...
        this.classes = inits.isInitialized("classes") ? new QClasses(forProperty("classes")) : null;
    }

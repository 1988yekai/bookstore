...
<template>
  <div class="login">
    <el-row>
     <!-- <el-col :span="12" :offset="6"><div class="grid-content bg-purple"> <label for="username" class="label">用户名:</label> <el-input v-model="username" placeholder="请输入用户名" style="inputwidth"></el-input></div></el-col> -->
